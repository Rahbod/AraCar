...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/bootstrap-theme.css?4.4');
    $cs->registerCssFile($baseUrl.'/css/responsive-theme.css?4.4');
    ...
    $cs->registerScriptFile($baseUrl.'/js/jquery.script.js?4.4', CClientScript::POS_END);
