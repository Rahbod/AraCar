...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/bootstrap-theme.css?1.1');
    $cs->registerCssFile($baseUrl.'/css/responsive-theme.css?1.1');
    ...
    $cs->registerScriptFile($baseUrl.'/js/jquery.script.js?1.1', CClientScript::POS_END);
    ?>
</head>
<body>
