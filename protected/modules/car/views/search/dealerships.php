	...
	<div class="center-box">
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 filters-container">
				<div class="close-container hidden-lg hidden-md col-md-12"><i class="menu-close-icon filter-box-trigger"></i><h4>فیلتر های نمایشگاه</h4></div>
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 list-container">
				...
				$this->widget('zii.widgets.CListView',array(
					...
					'itemsCssClass' => 'list-unstyled dealer-items items',
					'itemsTagName' => 'ul',
